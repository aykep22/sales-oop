                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-product.php?id=<?= $product_details['id'] ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                <a href="../actions/delete-product.php?id=<?= $product_details['id'] ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                            </td>
                            <?php
                            $quantity = $product_details['quantity'];
                            if($quantity > 0){
                                echo "<td><a href='buy-product.php?id=" . $product_details['id'] . "' class='btn btn-success'><i class='fa-solid fa-cash-register'></i></a></td>";
                            }else{
                                echo "<td></td>";
                            }
                            ?>
